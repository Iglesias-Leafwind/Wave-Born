...
if __name__ == "__main__":
    ...
    blocks = []
    #DELETE checking limits
    for line in range(blocks_y-7,blocks_y-2):
        blocks.append(Block([35*SCALE,line*SCALE],2))
    for line in range(blocks_y-14,blocks_y-11):
    ...
    for col in range(0,2):
        ...
        for line in range(blocks_y-15,blocks_y-16,-1):
            blocks.append(Block([col*SCALE,line*SCALE],0))
    for col in range(2,4):
        blocks.append(Block([col*SCALE,(blocks_y-17)*SCALE],1))
        for line in range(blocks_y-14,blocks_y-17,-1):
            blocks.append(Block([col*SCALE,line*SCALE],0))
    ...
    for col in range(5,7):
        ...
        for line in range(blocks_y-12,blocks_y-14,-1):
            blocks.append(Block([col*SCALE,line*SCALE],0))
    ...
    for col in range(9,13):
        blocks.append(Block([col*SCALE,(blocks_y-13)*SCALE],1))
        for line in range(blocks_y-10,blocks_y-13,-1):
            blocks.append(Block([col*SCALE,line*SCALE],0))
    ...
    for col in range(14,16):
        blocks.append(Block([col*SCALE,(blocks_y-16)*SCALE],1))
        for line in range(blocks_y-8,blocks_y-16,-1):
            blocks.append(Block([col*SCALE,line*SCALE],0))

    
    for col in range(0,1):
        for line in range(blocks_y,blocks_y-12,-1):
            blocks.append(Block([col*SCALE,line*SCALE],0))
    for col in range(1,2):
        for line in range(blocks_y,blocks_y-11,-1):
            blocks.append(Block([col*SCALE,line*SCALE],0))
    for col in range(2,4):
        for line in range(blocks_y,blocks_y-10,-1):
            blocks.append(Block([col*SCALE,line*SCALE],0))
    for col in range(4,5):
        for line in range(blocks_y,blocks_y-8,-1):
            blocks.append(Block([col*SCALE,line*SCALE],0))
    for col in range(5,7):
    ...
    for col in range(9,13):
        for line in range(blocks_y,blocks_y-5,-1):
            blocks.append(Block([col*SCALE,line*SCALE],0))
    for col in range(13,14):
        for line in range(blocks_y,blocks_y-4,-1):
            blocks.append(Block([col*SCALE,line*SCALE],0))
    for col in range(14,16):
        for line in range(blocks_y,blocks_y-3,-1):
            blocks.append(Block([col*SCALE,line*SCALE],0))
    
    chunk2 = Chunk(96+16*32,blocks,[[(blocks_y-14)*SCALE,(blocks_y-11)*SCALE]],[[(blocks_y-7)*SCALE,(blocks_y-2)*SCALE]],True)

    names = ["tunnelEntrance","mountainBridgeLeft","mountainBridgeRight","plane","planeWhole1","planeWhole2","planeWhole3"]
    chunk1 = Chunk.load_chunk(32,"./chunks/normal/"+names[0])
    ...
    #chunk2.save_chunk("./chunks/normal/tunnelEntrance")
